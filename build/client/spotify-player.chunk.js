...
!function (e) {
  ...
  var a = function a(e, t) {
    var n;
    var a = 'https://sdk.scdn.co/embedded/index.html';
    var u = s.defer();
    var c = new r();
    ...
    var f = function f(t) {
      this._options = this._sanitizeOptions(t), this._handleMessages = this._handleMessages.bind(this), this._messageHandlers = {}, this._eventListeners = {}, this._setupMessageHandlers(), this._connectionRequests = {}, this._getCurrentStateRequests = {}, this._getVolumeRequests = {}, this.isLoaded = u.promise.then(() => {
    ...
    return f.prototype._sanitizeOptions = function (t) {
      ...
      return this._eventListeners[e] = this._eventListeners[e] || [], this._eventListeners[e].indexOf(t) === -1 && (this._eventListeners[e].push(t), !0);
      ...
      return !(!n || !n.length) && (this._eventListeners[e] = n.filter(e => {
        return e !== t;
      }), !0);
      ...
      if (typeof n !== 'function') {
        var _r = 'getOAuthToken is not a function';
  ...
  (function (t) {
    ...
    var i = n(7);
    var a = typeof t.Uint8Array === 'function' && void 0 !== t.crypto && typeof t.crypto.getRandomValues === 'function';
    var u = a ? r : s;
